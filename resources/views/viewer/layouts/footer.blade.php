<footer id="grve-footer" data-sticky-footer="no" class="grve-border grve-bookmark">
    ...
    <div id="grve-bottom-bar" class="grve-bookmark">
        <div class="grve-section grve-row-section grve-fullwidth-background grve-padding-top-1x grve-padding-bottom-1x grve-bg-none grve-headings-light grve-custom-height grve-middle-content"  style="background-color:#333333;color:#ffffff;"><div class="grve-container"><div class="grve-row grve-bookmark grve-columns-gap-30"><div class="grve-column wpb_column grve-column-1-3 grve-align-center" ><div class="grve-column-wrapper" ><div class="grve-element grve-text grve-leader-text">
                                <p><a href="{{route('products')}}">Products</a> | <a href="{{route('closed-loop')}}">CLR</a> | <a href="{{route('markets')}}">Markets</a> | <a href="{{route('about-us')}}">About</a> | <a href="{{route('contact-us')}}">Contact</a></p>
                        ...
                        </div></div><div class="grve-column wpb_column grve-column-1 grve-align-center" ><div class="grve-column-wrapper" >
